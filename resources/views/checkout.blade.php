            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="text" class="form-control" name="building" value="" required="" placeholder="" />
                            </div>
                            <div class="col-sm-2">
                                <h2 class="h4">Zip</h2>
                    ...
                    <div class="row group">
                        ...
                        <input type="hidden" value=" {{Cart::session(\Illuminate\Support\Facades\Auth::user()->id)->getTotal()}}" name="total">
                ...
                <div class="col-sm-12 white">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-md-4">
                            <h3 class="h5 no-margin">Sub total: ${{Cart::session(\Illuminate\Support\Facades\Auth::user()->id)->getSubTotal()}}</h3>
                            <h3 class="h4 no-margin">Total: ${{Cart::session(\Illuminate\Support\Facades\Auth::user()->id)->getTotal()}}</h3>
                        </div>
